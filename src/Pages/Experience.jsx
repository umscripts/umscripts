    ...
    <div className='px-5 sm:px-10 lg:px-20 my-20 md:my-32 overflow-hidden' id='experience'>
      ...
      <div className="relative flex justify-center items-center pb-3">
        ...
        <div className="relative lg:w-1/2 pr-10 ">
          ...
          <div className="hidden sm:block mr-12 md:mr-20 lg:mr-0 relative p-3 shadow-custom-shadow rounded-lg space-y-1 hover:bg-Primary hover:text-white bg-PrimaryBG" data-aos="fade-right">
        ...
        <div className="lg:w-1/2 sm:space-y-60 flex flex-col gap-10">
          <div className="lg:ml-10 relative p-3 shadow-custom-shadow rounded-lg space-y-1 hover:bg-Primary hover:text-white bg-PrimaryBG" data-aos="fade-left">
            <div className="flex gap-2">
          ...
          <div className="sm:hidden mr-12 xsm:w-full sm:w-auto md:mr-20 lg:mr-0 relative p-3 shadow-custom-shadow rounded-lg space-y-1 hover:bg-Primary hover:text-white bg-PrimaryBG" data-aos="fade-left">
            <div className="flex gap-2">
              <a href="https://www.linkedin.com/company/agen-tech/posts/?feedView=all" target='_blank'><img src={agentechLogo} alt="Agentech" className="w-10 md:w-12 h-10 md:h-12" /></a>
              <div>
                <a href="https://www.linkedin.com/company/agen-tech/posts/?feedView=all" target='_blank'><h3 className="font-bold">Agentech</h3></a>
          ...
          <div className="lg:ml-10 relative p-3 shadow-custom-shadow rounded-lg space-y-1 hover:bg-Primary hover:text-white bg-PrimaryBG" data-aos="fade-left">
            <div className="flex gap-2">
              ...
              <a href="https://kfueit.edu.pk/" target='_blank'><img src={kfueitLogo} alt="KFUEIT" className="min-w-12 h-10 md:h-12 bg-white" /></a>
              <div>
